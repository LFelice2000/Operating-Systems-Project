...
# c) Elaborar un pipeline que cuente el n ́umero de l ́ıneas distintas al concatenar ((lista
...
cat lista de la compra Pepe.txt lista de la compra Elena.txt | sort | uniq | wc -l > num compra.txt 2> /dev/null
